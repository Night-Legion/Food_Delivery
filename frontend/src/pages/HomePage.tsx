...
const HomePage = () => {
    ...
    const featuredRestaurants = [
        ...
        { id: 2, name: "Pizza Heaven", rating: 4.5, deliveryTime: "30-40 min", cuisine: "Italian, Pizza", image: "/pizza-r.jpg" },
        { id: 3, name: "Sushi World", rating: 4.7, deliveryTime: "35-45 min", cuisine: "Japanese, Sushi", image: "/sushi-r.jpg" },
        { id: 4, name: "Taco Express", rating: 4.2, deliveryTime: "20-30 min", cuisine: "Mexican, Fast Food", image: "/taco-r.jpg" },
    ];
